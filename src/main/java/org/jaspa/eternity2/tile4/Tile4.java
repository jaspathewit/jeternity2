...
/**
 * Class encapsulates an Eternity2 puzzle tile made up from 4
 * other tiles
 */
public abstract class Tile4 implements Tile {

    private static final TileCriteria TOPRIGHTCRITERIA = new TileCriteria(MidTile4.class);
    private TileIdSet tileId;
    private Orientation orientation;
    private int[][] nameKeys = new int[2][2];
    ...
    // fields only used for Data store operations
     ...
     * @param left
     */
    public Tile4(String name, Tile topLeft, Tile topRight, Tile bottomRight, Tile bottomLeft) {
     ...
     * @param Bottom
     */
    public Tile4(String name, TileIdSet tileId, String topKey, String rightKey, String bottomKey, String leftKey) {
     ...
     */
    public Tile4 clone() throws CloneNotSupportedException {
     ...
     */
    protected void copy(Tile4 tile) {

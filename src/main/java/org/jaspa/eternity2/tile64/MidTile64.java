...
/**
 * Class represents a middle tile made from 64 tiles
 */
public class MidTile64 extends Tile64 {

    private static final TileCriteria BOTTOMRIGHTCRITERIA = new TileCriteria(MidTile64.class);
     ...
     */
    public MidTile64(String name, Tile topLeft, Tile topRight, Tile bottomRight, Tile bottomLeft) {
     ...
     */
    public MidTile64(String name, TileIdSet tileId, String topKey, String rightKey, String bottomKey, String leftKey) {
     ...
     */
    @Override
    public MidTile64 clone() {
        MidTile64 result = new MidTile64();
        copy(result);
        return result;
    }

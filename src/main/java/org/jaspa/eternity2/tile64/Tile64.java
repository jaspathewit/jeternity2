...
/**
 * Class represents an Eternity2 puzzle tile made up from 4 other tiles
 */
public abstract class Tile64 implements Tile {

    private static final TileCriteria TOPRIGHTCRITERIA = new TileCriteria(MidTile64.class);
    private TileIdSet tileId;
    private Orientation orientation;
    private int[][] nameKeys = new int[8][8];
     ...
     * @param left
     */
    public Tile64(String name, Tile topLeft, Tile topRight, Tile bottomRight, Tile bottomLeft) {
     ...
     * @param Bottom
     */
    public Tile64(String name, TileIdSet tileId, String topKey, String rightKey, String bottomKey, String leftKey) {
     ...
     */
    public Tile64 clone() throws CloneNotSupportedException {
     ...
     */
    protected void copy(Tile64 tile) {
